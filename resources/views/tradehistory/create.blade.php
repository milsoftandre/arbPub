        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0"><div class="card-title m-0"><h3 class="fw-bolder m-0">{{__('trade-history.add')}}</h3></div></div>

                        {{ Form::open(['route' => 'trade-history.store']) }}
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="row mb-6 pt-2">
                            ...
                            <label class="col-lg-4 col-form-label fw-bold fs-6">
                                <span>{{__('trade-history.rpwd')}}</span>
                            </label>
                                            <div class="col-lg-8 fv-row">
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="reset" class="btn btn-white btn-active-light-primary me-2"> {{__('trade-history.cansel')}} </button>
                        <button type="submit" id="kt_account_profile_details_submit" class="btn btn-primary">
                            <span class="indicator-label"> {{__('trade-history.save')}} </span></span>
                        </button>
                    </div>
                    {{ Form::close() }}
                </div>
