        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    @if ($settings['isAdd'])
                        <a href="{{ route('trade-history.create') }}" class="btn btn-sm btn-primary">{{ $settings['buttons']['add'] }}</a>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="col-md-12">
                            {{ Form::open(['route' => ['trade-history.index'],'method' => 'get']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 right">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('trade-history.index') }}" class="btn btn-danger"> Clear </a><button type="submit" class="btn btn-primary">
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Trade details</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
<pre>{{@$row->formtPrices()}}</pre>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    @if ($t!='price'&&$t!='currency_pairs'&&$t!='prices')
