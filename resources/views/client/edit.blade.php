        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0"><div class="card-title m-0"><h3 class="fw-bolder m-0">{{__('client.edit')}}</h3></div></div>
                    {{ Form::open(['route' => ['client.update',$model->id]]) }}
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('client.index') }}" class="btn btn-white btn-active-light-primary me-2"> {{__('bot.cansel')}} </a>
                        <button type="submit" id="kt_account_profile_details_submit" class="btn btn-primary">
                            <span class="indicator-label"> {{__('client.edit')}} </span></span>
                        </button>
                    </div>
                    {{ Form::close() }}
                </div>
