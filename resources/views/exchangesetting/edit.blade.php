        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    {{ Form::open(['route' => ['exchange-settings.update',$model->id]]) }}
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="row mb-6 pt-2">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                @endif
                                    @if($field=='time')
                                        {{ Form::input('time',$fname, $model->$fname, ['placeholder'=> $settings['attr'][$fname], 'class'=>'form-control form-control-lg form-control-solid']) }}
                                    @endif
                                    @if($field=='password')
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" id="kt_account_profile_details_submit" class="btn btn-primary">
                            <span class="indicator-label"> {{__('exchange-settings.edit')}} </span></span>
                        </button>
                    </div>
                    {{ Form::close() }}
                </div>
