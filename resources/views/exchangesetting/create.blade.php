        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0"><div class="card-title m-0"><h3 class="fw-bolder m-0">{{__('exchange-settings.add')}}</h3></div></div>

                        {{ Form::open(['route' => 'exchange-settings.store']) }}
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="row mb-6 pt-2">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                @endif
                                    @if($field=='time')
                                        {{ Form::input('time',$fname, null, ['placeholder'=> $settings['attr'][$fname], 'class'=>'form-control form-control-lg form-control-solid']) }}
                                    @endif
                                    @if($field=='password')
                            ...
                            <label class="col-lg-4 col-form-label fw-bold fs-6">
                                <span>{{__('exchange-settings.rpwd')}}</span>
                            </label>
                                            <div class="col-lg-8 fv-row">
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <a href="{{ route('exchange-settings.index') }}" class="btn btn-white btn-active-light-primary me-2"> {{__('bot.cansel')}} </a>
                        <button type="submit" id="kt_account_profile_details_submit" class="btn btn-primary">
                            <span class="indicator-label"> {{__('exchange-settings.save')}} </span></span>
                        </button>
                    </div>
                    {{ Form::close() }}
                </div>
